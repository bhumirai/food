...
<body>
  ...
  <a class="navbar-brand" href="index.php">Food For U</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link " href="foodlist.php">foodlist</a>
      </li>
      ...
      <li class="nav-item pr-1">
        <form method="POST" class="form-inline mt-1" action="search.php">
          <input type="text" name="search" placeholder="search" class="form-control mr-1">
            <button class="btn btn-light btn-outline-success btn-md" name="submit-search"><i class="fas fa-search">sarch</i>
            </button>
        </form>
      </li>
...
?>
 ...
 <div class="jumbotron text-center">
   <h1>Welcome To Food For U <i class="fas fa-utensils"></i></h1>
 </div>
 <!--jumbotron code-->
